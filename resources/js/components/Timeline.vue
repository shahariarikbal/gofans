<template>
    <div>
        ...
        <!--Edit Modal-->
        <div class="modal fade" data-backdrop="false" id="timeLineModal" tabindex="-1" role="dialog" aria-labelledby="timeLineModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 id="timeLineModalLabel">Update your post</h3>
                    </div>
                    <div class="modal-body">
                        <form @submit.prevent="updatePost()" method="post" enctype="multipart/form-data">
                            ...
                            <div class="modal-img">
                                <img src=" " id="newsFeedImage" style="width: 700px; margin-top: 10px;"/>
...
<script>
    ...
    export default {
        ...
        methods: {
            getNewsfeed(){
                var _this = this;
                axios.post(_this.ApiUrl+'get-newsfeed', {username: _this.$route.params.username })
            ...
            replyStore(commentId) {
                ...
                axios.post(_this.ApiUrl+'reply-store', {
                    ...
                    .catch(error => {
                        console.log('Reply User api not working !!')
                    });
            },
