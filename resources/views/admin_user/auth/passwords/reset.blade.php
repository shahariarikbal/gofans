...
<head>
    ...
    <title>Go Fans Audience | Login</title>
    ...
    <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url({{ asset('admin') }}/images/auth-bg.jpg) no-repeat center center;">
        <div class="auth-box">
            ...
            <div id="loginform">
                ...
                <div class="row">
                    <div class="col-12">
                        <form class="form-horizontal mt-3" method="post" action="{{ route('AdminUser.password.request') }}">
                            @csrf
                            ...
                            <div>
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-custom" id="basic-addon2"><i class="ti-email"></i></span>
                                    </div>
                            ...
                            <div>
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-custom" id="basic-addon2"><i class="ti-key"></i></span>
                                    </div>
