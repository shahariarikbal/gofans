    ...
    <div class="page-content container-fluid">
        <div class="row mb-3">
            <div class="col-sm-12 col-md-6">
                <h3 class="font-light">Skill List</h3>
            </div>
            <div class="col-sm-12 col-md-6">
                            ...
                            <table class="goTable table table-striped border">
                                ...
                                @if(!empty($data))
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('skill.edit', $subject->id) }}" class="btn btn-outline-info btn-circle btn-circle ml-2">
                                                <i class="ti-pencil-alt"></i>
                                            </a>
                                            <a href="javascript:void(0)" onclick="deleteRow('{{ route('skill.destroy', $subject->id) }}')" class="btn btn-outline-info btn-circle btn-circle ml-2">
                                                <i class="ti-trash"></i>
                                            </a>
                                        </td>
                                    </tr>
