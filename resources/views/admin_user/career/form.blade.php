...
@section('title')
    Admin | Career | {{ isset($data)?'Edit':'Create' }}
@endsection
    ...
    <div class="page-content container-fluid">
        <div class="row mb-3">
            <div class="col-sm-12 col-md-6">
                <h3 class="font-light">Career {{ isset($data)?'Edit':'Create' }}</h3>
            </div>
            <div class="col-sm-12 col-md-6">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-xs-12">
                <form  method="post" action="{{ isset($data)?route('career.update', $data->id):route('career.store') }}" novalidate>
