    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <span><a href="{{ route('client.web.home') }}">Home</a>Terms &amp; Conditions</span>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-lg-12" id="advertiser">
                <div class="section-heading" style="margin-top: 20px; margin-bottom: 20px;">
                    <h3>ADVERTISERS TERMS AND CONDITIONS</h3>
                </div>
            ...
            <div class="col-lg-12" id="publishers">
                <div class="section-heading" style="margin-top: 20px; margin-bottom: 20px;">
                    <h3>PUBLISHERS TERMS AND CONDITIONS</h3>
                </div>
