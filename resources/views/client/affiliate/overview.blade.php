    ...
    <div class="page-content container-fluid">
        <div class="row mb-3">
            <div class="col-sm-12 col-md-6">
                <label class="form-inline"><h3 class="font-light">Overview </h3><span class="ml-1"> Affiliate program</span></label>
            </div>
            <div class="col-sm-12 col-md-6">
            ...
            <div class="col-md-12 col-lg-4">
                ...
                <div class="card">
                    <div class="card-header bg-gradient-info text-center text-white">
                        <h2> ayeT-Studios Affiliate Program</h2>
                        <span class="_sort_title">targeting app publishers / developers worldwide</span>
                    </div>
                    <div class="box_blue">
                        <div class="card-body text-justify">
                            <h1 class="_amount text-center">$ 50</h1>

                            <ul class="pricing-content list-unstyled">
                                <li>
                                    <i class="fa fa-angle-right"></i>Earn $50 once a publisher you referred earned his first $100.
                                </li>
                            </ul>
                            ...
                            <div class="pricing-footer">
                                ...
                                <p>
                                </p><pre id="link-cashpirate">https://www.ayetstudios.com/publisher-signup/ILPESD</pre>
                                <p></p>
                                <a href="#" class="btn btn-danger">
                                    Copy Referral Link <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div>
                    </div>
