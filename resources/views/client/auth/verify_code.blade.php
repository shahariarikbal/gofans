...
<head>
    ...
    <title>Go To Top Client | Verify Code</title>
    ...
    <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url({{ asset('admin') }}/images/auth-bg.jpg) no-repeat center center;">
        <div class="auth-box">
            ...
            <div id="loginform">
                ...
                <div class="row">
                    <div class="col-12">
                        <form class="form-horizontal mt-3" method="post" action="{{ route('client.verifyCodeLogin') }}">
                            @csrf
                           <div>
                               @error('code')
                        ...
                        <div class="form-group">
                            <div class="form-group mb-0 mt-2">
                                <div class="col-sm-12 text-center">
                                    Try again login? <a href="{{ route('client.login') }}" class="text-custom ml-1"><b>Login</b></a>
                                </div>
                            </div>
                        </div>
                    </div>
