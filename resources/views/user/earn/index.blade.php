                            ...
                            <div class="p-lg-3 p-2">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ml-4" style="width: 38%;">
                                        <a href="{{ route('user.earnPointService', $service->id) }}">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-gradient-success text-white">
                        <h4 class="card-title"><i class="fa fa-comments"></i> Description</h4>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered table-striped">
                            ...
                            @if(!empty($category->services))
                                @foreach($category->services as $service)
                                    @if(!empty($service->campaign))
                                        @foreach ($service->campaign as $campaign)
                                            <tr>
                                                <td>{{$campaign->id}}</td>
