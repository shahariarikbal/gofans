...
<div class="topbar stick">
    ...
    <div class="top-area">
        <ul class="main-menu">
            <li>
                <a href="{{ url('/timeline/'.auth()->user()->id) }}">
                    @if(Auth::check())
                        @if(auth()->user()->profile_photo!='' && file_exists('storage/images/'.auth()->user()->profile_photo))
                            <img src="{{ asset('storage/images/'.auth()->user()->profile_photo) }}" alt="{{ auth()->user()->name }}" class="auth-avatar">
                        @else

                            <img src="{{ asset('goweb/images/avatar.png') }}" alt="{{ auth()->user()->name }}" class="auth-avatar">
                        @endif
                        {{ Auth::guard('web')->user()->name }}
                    @else
                        <img src="{{ asset('goweb/images/avatar.png') }}" alt="Guest" class="auth-avatar">
                        Guest
                    @endif
                </a>
        ...
        <ul class="setting-area">
            ...
            <a href="{{ url('/newsfeed') }}" title="Home"><i class="ti-home"></i></a>
            <li>
                ...
                <div class="dropdowns">
                    ...
                    <ul class="drops-menu">
                        <li>
                            <a href="#" title="">
                                <img src="{{ asset('goweb') }}/images/resources/thumb-1.jpg" alt="">
                                <div class="mesg-meta">
                                    <h6>sarah Loren</h6>
                        ...
                        <li>
                            <a href="#" title="">
                                <img src="{{ asset('goweb') }}/images/resources/thumb-2.jpg" alt="">
                                <div class="mesg-meta">
                                    <h6>Jhon doe</h6>
                                    <span>Hi, how r u dear ...?</span>
                                    <i>2 min ago</i>
                        ...
                        <li>
                            <a href="#" title="">
                                <img src="{{ asset('goweb') }}/images/resources/thumb-3.jpg" alt="">
                                <div class="mesg-meta">
                                    <h6>Andrew</h6>
                                    <span>Hi, how r u dear ...?</span>
                                    <i>2 min ago</i>
                        ...
                        <li>
                            <a href="#" title="">
                                <img src="{{ asset('goweb') }}/images/resources/thumb-4.jpg" alt="">
                                <div class="mesg-meta">
                                    <h6>Tom cruse</h6>
                                    <span>Hi, how r u dear ...?</span>
                                    <i>2 min ago</i>
                        ...
                        <li>
                            <a href="#" title="">
                                <img src="{{ asset('goweb') }}/images/resources/thumb-5.jpg" alt="">
                                <div class="mesg-meta">
                                    <h6>Amy</h6>
                                    <span>Hi, how r u dear ...?</span>
                                    <i>2 min ago</i>
        ...
        <div class="user-img">
            ...
            <div class="user-setting">
                ...
                <a onclick="event.preventDefault(); document.getElementById('logout-form').submit();" href="javascript:void(0)"><i class="ti-power-off"></i>log out</a>
