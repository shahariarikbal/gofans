    ...
    <div class="page-content container-fluid">
        <div class="row mb-3">
            <div class="col-sm-12 col-md-6">
                <h3 class="font-light">Client Profile</h3>
            </div>
            <div class="col-sm-12 col-md-6">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-xlg-3 col-md-5">
                <div class="card">
                    <div class="card-body">
                        <center class="mt-4"> <img src="{{ asset('admin') }}/images/users/5.jpg" class="rounded-circle" width="150" />
            ...
            <div class="col-lg-8 col-xlg-9 col-md-7">
                <div class="card">
                    ...
                    <ul class="nav nav-pills custom-pills" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="pills-campaign-tab" data-toggle="pill" href="#previous-month" role="tab" aria-controls="pills-campaign" aria-selected="false">Campaign</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="pills-transaction-tab" data-toggle="pill" href="#previous-month" role="tab" aria-controls="pills-transaction" aria-selected="false">Transaction</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="pills-log-tab" data-toggle="pill" href="#previous-month" role="tab" aria-controls="pills-log" aria-selected="false">Log History</a>
                        </li>
                    </ul>
                    <!-- Tabs -->
                                ...
                                <div class="steamline mt-0">
                                    <div class="sl-item">
                                        ...
                                        <div class="sl-right">
                                            <div><a href="javascript:void(0)" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-3 col-md-6 mb-3"><img src="{{ asset('admin') }}/images/big/img1.jpg" class="img-fluid rounded" /></div>
                                                    <div class="col-lg-3 col-md-6 mb-3"><img src="{{ asset('admin') }}/images/big/img2.jpg" class="img-fluid rounded" /></div>
                                                    <div class="col-lg-3 col-md-6 mb-3"><img src="{{ asset('admin') }}/images/big/img3.jpg" class="img-fluid rounded" /></div>
                                                    <div class="col-lg-3 col-md-6 mb-3"><img src="{{ asset('admin') }}/images/big/img4.jpg" class="img-fluid rounded" /></div>
                                                </div>
                                    ...
                                    <div class="sl-item">
                                        ...
                                        <div class="sl-right">
                                            <div> <a href="javascript:void(0)" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                                <div class="mt-3 row">
                                                    <div class="col-md-3 col-xs-12"><img src="{{ asset('admin') }}/images/big/img1.jpg" alt="user" class="img-fluid rounded" /></div>
                                    ...
                                    <hr>
                                    <div class="sl-item">
                                        <div class="sl-left"> <img src="{{ asset('admin') }}/images/users/3.jpg" alt="user" class="rounded-circle" /> </div>
                                        <div class="sl-right">
                                            <div><a href="javascript:void(0)" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                    ...
                                    <hr>
                                    <div class="sl-item">
                                        <div class="sl-left"> <img src="{{ asset('admin') }}/images/users/4.jpg" alt="user" class="rounded-circle" /> </div>
                                        <div class="sl-right">
                                            <div><a href="javascript:void(0)" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
